...
const KULSWAMINI_MENU_ITEMS: MenuItem[] = [
  // THALI SPECIALS
  { id: 'm100', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Kulswamini Special Fish Thali (Chilapi)', description: 'Includes: 2 Pcs Fish Masala, 2 Pcs Kadak Fry, Curry/Rassa, Aalandi Soup, 2 Bhakri / 3 Chapati, Indrayani Rice, Solkadhi & Sukat', price: 300, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm101', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Special Chicken Thali', description: 'Includes: Chicken Fry, Chicken Rassa, Soup, Indrayani Rice, 2 Bhakri / 2 Chapati, 1 Boiled Egg & Solkadhi', price: 230, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm102', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Special Mutton Thali', description: 'Includes: Mutton Fry, Spicy Mutton Rassa, Aalandi Soup, Indrayani Rice, 1 Boiled Egg, 2 Bhakri / 3 Chapati & Solkadhi', price: 300, image_url: '/images/dishes/mutton_thali.jpg', is_available: true, sort_order: 3, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm103', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Masala Fish Thali (Chilapi)', description: 'Includes: 4 Pcs Fish Masala Curry, Spicy Rassa, Aalandi Soup, 2 Bhakri / 3 Chapati & Indrayani Rice', price: 220, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 4, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm104', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Kadak Fish Fry Thali (Chilapi)', description: 'Includes: 4 Pcs Crispy Kadak Fry, Spicy Rassa, Aalandi Soup, 2 Bhakri / 3 Chapati & Indrayani Rice', price: 220, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 5, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm105', category_id: 'c1000000-0000-0000-0000-000000000001', name: 'Aalandi Fish Thali (Chilapi)', description: 'Includes: 4 Pcs Mild Aalandi Fish, Rassa, Soup, 2 Bhakri / 3 Chapati & Indrayani Rice', price: 220, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 6, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  // FISH SPECIALS
  { id: 'm200', category_id: 'c1000000-0000-0000-0000-000000000002', name: 'Dum Fish Fry (दम मच्छी)', description: 'Steamed & shallow fried spiced whole fish in special masala', price: 150, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm201', category_id: 'c1000000-0000-0000-0000-000000000002', name: 'Crispy Fish Fry (फ्राय मच्छी)', description: 'Traditional Tawa fried crispy fish with red chili masala marinade', price: 150, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm202', category_id: 'c1000000-0000-0000-0000-000000000002', name: 'Bangda Tava Fish (बांगडा तवा)', description: 'Fresh Mackerel marinated in Kokum & Konkani spices, tava fried', price: 160, image_url: '/images/dishes/fish_thali.jpg', is_available: true, sort_order: 3, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm203', category_id: 'c1000000-0000-0000-0000-000000000002', name: 'Bangda Rava Fish (बांगडा रवा)', description: 'Mackerel coated in semolina (Rava) for an extra crunchy texture', price: 160, image_url: '/images/dishes/bombil_fry.jpg', is_available: true, sort_order: 4, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'm206', category_id: 'c1000000-0000-0000-0000-000000000002', name: 'Bombil Fry (बॉबील फ्राय)', description: 'Golden crispy rava fried Bombay Duck fish - crisp outside, tender inside', price: 180, image_url: '/images/dishes/bombil_fry.jpg', is_available: true, sort_order: 7, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

  // BIRYANI
  { id: 'm300', category_id: 'c1000000-0000-0000-0000-000000000003', name: 'Chicken Dum Biryani - Full', description: 'Aromatic basmati rice cooked on dum with marinated tender chicken pieces', price: 210, image_url: '/images/dishes/dum_biryani.jpg', is_available: true, sort_order: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm301', category_id: 'c1000000-0000-0000-0000-000000000003', name: 'Chicken Dum Biryani - Half', description: 'Half portion aromatic chicken dum biryani', price: 140, image_url: '/images/dishes/dum_biryani.jpg', is_available: true, sort_order: 2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm302', category_id: 'c1000000-0000-0000-0000-000000000003', name: 'Mutton Dum Biryani - Full', description: 'Rich & flavorful dum biryani cooked with succulent mutton pieces', price: 300, image_url: '/images/dishes/dum_biryani.jpg', is_available: true, sort_order: 3, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm303', category_id: 'c1000000-0000-0000-0000-000000000003', name: 'Mutton Dum Biryani - Half', description: 'Half portion rich mutton dum biryani', price: 180, image_url: '/images/dishes/dum_biryani.jpg', is_available: true, sort_order: 4, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

  // CHICKEN
  { id: 'm400', category_id: 'c1000000-0000-0000-0000-000000000004', name: 'Chicken Fry (चिकन फ्राय)', description: 'Spicy dry fried chicken tossed with caramelized onions and Maharashtrian spices', price: 150, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'm402', category_id: 'c1000000-0000-0000-0000-000000000004', name: 'Chicken Sukka (चिकन सुकी)', description: 'Semi-dry roasted chicken dish with toasted coconut & Malvani spices', price: 120, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 3, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm403', category_id: 'c1000000-0000-0000-0000-000000000004', name: 'Chicken Handi - Full', description: 'Rich Handi chicken gravy cooked in earthen pot with roasted spices (Serves 3-4)', price: 700, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 4, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm404', category_id: 'c1000000-0000-0000-0000-000000000004', name: 'Chicken Handi - Half', description: 'Half portion rich Handi chicken gravy (Serves 2)', price: 400, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 5, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

  // MUTTON
  { id: 'm500', category_id: 'c1000000-0000-0000-0000-000000000005', name: 'Mutton Fry (मटन फ्राय)', description: 'Tender goat meat dry fried in spicy Konkani black masala', price: 270, image_url: '/images/dishes/mutton_thali.jpg', is_available: true, sort_order: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'm501', category_id: 'c1000000-0000-0000-0000-000000000005', name: 'Mutton Masala Gravy', description: 'Mutton pieces simmered in spicy onion, ginger, garlic & coconut gravy', price: 270, image_url: '/images/dishes/mutton_thali.jpg', is_available: true, sort_order: 2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'm503', category_id: 'c1000000-0000-0000-0000-000000000005', name: 'Mutton Handi Malvani - Half', description: 'Half portion Malvani style mutton handi (Serves 2)', price: 500, image_url: '/images/dishes/mutton_thali.jpg', is_available: true, sort_order: 4, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'm801', category_id: 'c1000000-0000-0000-0000-000000000009', name: 'Wheat Chapati (चपाती)', description: 'Soft whole wheat thin chapati roti', price: 20, image_url: '/images/dishes/chicken_thali.jpg', is_available: true, sort_order: 2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
